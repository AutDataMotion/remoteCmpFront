...
const globalConf={
  ...
  themeConf : [
    ...
    },
    {
      ...
      descriptionRule:'利用光学遥感卫星视频可以实现指定目标监控，在机场、商场、道路流量监测等方面具有重要的应用价值，但卫星视频数据存在目标尺寸相对较小、背景抖动、目标大范围旋转等问题，自动化跟踪是实现应用的一个难点。针对空间信息网络多维、多尺度空间信息链路传输与处理瓶颈，通过本项竞赛遴选优秀的光学遥感卫星视频目标自动跟踪算法模型，实现空间信息网络对地物目标的在线实时跟踪，同时将跟踪结果经链路直接传回，提高空间信息网络在轨实时处理能力和链路传输效率。',
    },
  ],
};
