    ...
    return (
      <div className="contentEditorHtmlOutput" data-spm-anchor-id="5176.12281976.0.i1.34164c2ajQFYls">
        ...
        <p>
          ...
          遥感图像语义分割、遥感图像变化检测和遥感卫星视频目标跟踪五个竞赛单元，并在决赛中设置基于华为智能处理器的遥感图像解译加分赛。
        ...
        <p>
          现场算法模型测试环节中，要求各参赛队伍携带笔记本电脑，利用竞赛组织方提供的云服务器进行算法模型环境搭建，基于相应测试数据现场测试算法模型，并进行方案效果展示。竞赛组织方将对模型现场解译和处理结果进行审查，并基于算法效率、模型精度、模型大小等指标加权，对算法模型性能进行综合评估与排名，具体评价方式将在决赛阶段公布。决赛加分赛环节中，由竞赛组织方提供华为Atlas 200 Developer Kit智能开发套件，参赛队伍须将决赛算法模型移植于华为Atlas 200 Developer Kit智能开发平台，实现算法模型的推理计算。
        ...
        <p>
          材料提交：① 晋级复审答辩的团队需提前准备答辩材料，包括答辩PPT、算法模型源代码和说明文档、参赛总结及其他相关材料；② 复审答辩将邀请每支队伍2位代表参加，由组委会承担差旅费用。
        </p>
        <p>
