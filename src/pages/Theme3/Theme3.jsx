...
const introBannerProp={
  ...
  cmpInfoConf:{},
  dataDownloadConf:{
    dataUrl: 'https://pan.baidu.com/s/1ENqd2cbw0WOzHN5Oz8EvYw',
    fetchCode: '6hcx',
  },
  commitResConf:{},
  hotRankConf:{},
...
export default class Theme3 extends Component {
  ...
  render() {
    return (
      <Row gutter="20" wrap>
        <Col l="24" xxs="24">
          <IntroBanner themeConf={globalConf.themeConf[2]} />
        </Col>
        <Col l="24" xxs="24">
          <div  style = {styles.sOverview}> <Overview themeConf={globalConf.themeConf[2]}/></div>
