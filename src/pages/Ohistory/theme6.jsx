  ...
  render() {
    ...
    return (
      <div className={'info-paragraph-history'}>
        ...
        <p>
          进入“遥感图像稀疏表征与智能分析竞赛”决赛的团队必须参加本项加分赛。本项加分赛由大赛主办方提供华为Atlas 200 DK AI开发者套件和遥感图像测试数据集，要求参赛队伍将参与决赛的算法模型移植于华为Atlas 200 DK AI开发者套件，并在对应遥感图像测试数据集上实现算法模型的推理计算。
        </p>
        ...
        <p>
          竞赛设备：竞赛主办方将为参加决赛加分赛的团队提供华为Atlas 200 DK AI开发者套件和详细技术文档 (请参考附件一<a href={globalConf.genUrlFront('2019_att1.docx')}>【点击下载】</a>)，由各参赛队伍携带笔记本电脑进行环境搭建、模型移植和图像解译模型推理计算。为方便参赛队伍参与决赛加分赛，大赛组织方构建了Atlas 200 DK AI开发者讨论区(<a href="https://www.huawei.com/minisite/ascend/cn/index.html">【点击进入】</a>)，提供Atlas 200 DK AI开发者套件的详细介绍、安装配置、开发指导、体验指引、Q&A等资源，参赛队员可在社区自由下载开发资源及提问交流。决赛加分赛实施期间，竞赛主办方也将组织专家提供技术指导。
        </p>
        <p>
        ...
        <div className={'info-paragraph-text-center'}>
          <br />
          <a href="https://www.vmall.com/product/10086085080100.html?cid=78120">
          <img
          ...
          <img
            ...
            href="https://www.vmall.com/product/10086085080100.html?cid=78120"
            alt=""
          />
          {/* <p id="figure-name">
            图1 {globalConf.themeConf[themeId].title}Atlas 200 DK
