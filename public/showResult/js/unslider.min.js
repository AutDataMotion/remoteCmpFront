(function (e, t) {
  ...
  var n = function () {
    ...
    this.init = function (t, n) {
      ...
      this.liCnt = this.items.length;
      // console.log("items", this.items, "length", this.liCnt);
  ...
  // 单例模式
  var sliderSingle = new n;
  e.fn.unslider = function (t) {
    var r = this.length;
    return this.each(function (i) {
      var s = e(this);
      var u = sliderSingle.init(s, t);
